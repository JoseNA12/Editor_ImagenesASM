...
// progra_2.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(Cprogra_2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de Cprogra_2App

Cprogra_2App::Cprogra_2App()
{
...
// El único objeto Cprogra_2App

Cprogra_2App theApp;


// Inicialización de Cprogra_2App

BOOL Cprogra_2App::InitInstance()
{
